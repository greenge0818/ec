...
define(function (require, exports, module) {
	...
	var mootools = require("js/plugin/mootools-core"),
	Element = mootools.Element,
	Elements = mootools.Elements,
	Fx = mootools.Fx,
	$extend=mootools.$extend,
	Browser = mootools.Browser,
	$empty = mootools.$empty
...
var Mediabox; (function() {
    ...
    function() {
        document.id(document.body).adopt($$([S = new Element("div", {
            id: "mbOverlay"
        }).addEvent("dblclick", N),xfclose=new Element("a", {
			id:"guide_close",
			class:"guide_close"
		...
		xfbtm = new Element("div",{
			id:"botBar"
		}).injectInside(b).adopt(E = new Element("div", {
			id: "mbTitle"
		}), W = new Element("div", {
			id: "mbNumber"
        }));
        c = new Element("div", {
            id: "mbBottom"
        }).injectInside(b).adopt(e = new Element("a", {
            id: "mbNextLink",
            href: "#"
        }).addEvent("click", g), T = new Element("a", {
            id: "mbPrevLink",
            href: "#"
        }).addEvent("click", K), M = new Element("div", {
            id: "mbCaption"
        }));
        y = {
