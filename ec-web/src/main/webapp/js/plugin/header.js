define(function(require,exports,module){
    ...
    $(".popueButton").hover(function () {
        ...
        inPanel = true;
       // $(this).addClass("hover");
        $(this).closest("li").find(".popuePanel").show();
    }, function () {
        inPanel = false;
    ...
    $(".popuePanel").hover(function () {
        inPanel = true;
		$(this).closest("li").find(".popueButton").addClass("hover");
    }, function () {
        inPanel = false;
    ...
    //搜索框下拉
    $(".search_input .choose").mouseover(function () { $(".choose_hide").show(); });
    $(".search_input .choose").mouseout(function () { $(".choose_hide").hide(); });
